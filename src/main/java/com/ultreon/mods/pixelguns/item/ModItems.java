...
public class ModItems {
    ...
    public static final Item LIGHT_ASSAULT_RIFLE = ModItems.registerItem("assaultrifle_light", new GunItem(new FabricItemSettings().group(PixelGuns.GUNS).maxCount(1), 5.5f, 2, 256, STANDARD_RIFLE_BULLET, 44, 0.15f, 1.625f, 1, 1, ModSounds.RELOAD_GENERIC_AR_P1, ModSounds.RELOAD_GENERIC_AR_P2, ModSounds.RELOAD_GENERIC_AR_P3, ModSounds.ASSAULTRIFLE_LIGHT, 1, false, 6, 18, 37) {
    });
    public static final Item HEAVY_ASSAULT_RIFLE = ModItems.registerItem("assaultrifle_heavy", new AssaultRifleItem(new FabricItemSettings().group(PixelGuns.GUNS).maxCount(1), 8.0f, 3, 128, STANDARD_RIFLE_BULLET, 48, 0.125f, 2.5f, 1, 1, ModSounds.RELOAD_HEAVY_AR_P1, ModSounds.RELOAD_HEAVY_AR_P2, ModSounds.RELOAD_HEAVY_AR_P3, ModSounds.ASSAULTRIFLE_HEAVY, ModSounds.ASSAULTRIFLE_HEAVY_EG, 1, false, 6, 22, 40) {
    });
