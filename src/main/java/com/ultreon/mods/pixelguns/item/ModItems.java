...
public class ModItems {
    ...
    public static final Item ROCKET_LAUNCHER = ModItems.registerItem("rocket_launcher", new RocketLauncherItem(new FabricItemSettings().group(ModCreativeTab.WEAPONS).maxCount(1), 0, 0, 0, null, 0, 0, 0, 0, 0, null, null, null, null, 0, false, 0, 0, 0)
    );
